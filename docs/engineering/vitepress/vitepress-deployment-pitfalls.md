...
> 一次完整的"GitHub 仓库 + GitHub Pages + VitePress"部署实战，记录我在这个过程中踩过的坑、绕过的弯路，以及最后悟到的经验。
...
这次部署一共踩了 7 个坑，花了大概 3 小时。如果有人提前告诉我所有这些坑，可能 30 分钟就能搞定。
